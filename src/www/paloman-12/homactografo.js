(function(builder) {
    ...
    class Utilidades {
        ...
        static alfabeto_ingles = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
        static generar_texto_aleatorio(caracteres = 10, alfabeto = this.alfabeto_ingles) {
    ...
    class Escena_estandar {
        ...
        establecer_fondo_fijo(imagen) {
            Utilidades.tracear("Escena_estandar.establecer_fondo_fijo", arguments, this);
            new BABYLON.Layer("", imagen, this.$scene, true);
            return this;
        }
    ...
    class Video_de_youtube_estandar {
        static get parametros_por_defecto() {
            return {
                autorreproduccion: 1
            };
        }
        constructor(homactografo, id, video_id, parametros = {}) {
            Utilidades.tracear("Video_de_youtube_estandar.constructor", arguments, this);
            this.homactografo = homactografo;
            this.id = id;
            this.video_id = video_id;
            this.uid = Utilidades.generar_texto_aleatorio();
            this.parametros = Object.assign({}, this.constructor.parametros_por_defecto, parametros);
            this.prepararse();
        }
        prepararse() {
            Utilidades.tracear("Video_de_youtube_estandar.prepararse", arguments, this);
            this.$iframe_container = document.createElement("div");
            this.$iframe_container.id = this.uid;
            this.$iframe_container.class = "homactografo3d_contenedor_de_video_de_youtube";
            this.$iframe_container.innerHTML = `<iframe width='1280' height='720' src='https://www.youtube.com/embed/${this.video_id}' frameborder='0' allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>`;
            this.$iframe = this.$iframe_container.querySelector("iframe");
            this.$iframe.class = "homactografo3d_video_de_youtube";
            this.$iframe_container.appendChild(this.$iframe);
            this.homactografo.$canvas.appendChild(this.$iframe_container);
            if(this.parametros.autorreproduccion) {
                this.reproducirse();
            }
        }
        reproducirse() {
            Utilidades.tracear("Video_de_youtube_estandar.reproducirse", arguments, this);
        ...
        pararse() {
            Utilidades.tracear("Video_de_youtube_estandar.pararse", arguments, this);
            this.$iframe.contentWindow.postMessage(JSON.stringify({
                event: "command",
                func: "pauseVideo",
                args: ""
        ...
        reiniciarse() {
            Utilidades.tracear("Video_de_youtube_estandar.reiniciarse", arguments, this);
            this.$iframe.contentWindow.postMessage(JSON.stringify({
                event: "command",
                func: "stopVideo",
                args: ""
    ...
    class Sonido_estandar {
        static get parametros_por_defecto() {
            return {
                autorreproduccion: 1
            };
        }
        constructor(homactografo, id, ruta, parametros = {}) {
            Utilidades.tracear("Sonido_estandar.constructor", arguments, this);
            this.homactografo = homactografo;
            this.id = id;
            this.ruta = ruta;
            this.parametros = Object.assign({}, this.constructor.parametros_por_defecto, parametros);
        ...
        prepararse() {
            Utilidades.tracear("Sonido_estandar.prepararse", arguments, this);
            this.$sound = new BABYLON.Sound(this.id, this.ruta, this.homactografo.escena_actual.$scene, () => {
                if(this.parametros.autorreproduccion) {
                    this.$sound.play();
                }
            });
        ...
        reproducirse() {
            Utilidades.tracear("Sonido_estandar.reproducirse", arguments, this);
            this.$sound.play();
            return this;
        }
        pararse() {
            Utilidades.tracear("Sonido_estandar.pararse", arguments, this);
            this.$sound.pause();
            return this;
        }
        reiniciarse() {
            Utilidades.tracear("Sonido_estandar.reiniciarse", arguments, this);
            this.$sound.stop();
            return this;
        }
    }
    ...
    class Camara_estandar extends Objeto_estandar {
        ...
        enfocarse_a(objeto_estandar_o_babylon_mesh) {
            Utilidades.tracear("Camara_estandar.enfocarse_a", arguments, this);
            if (objeto_estandar_o_babylon_mesh instanceof Objeto_estandar) {
                this.$camera.setTarget(objeto_estandar_o_babylon_mesh.$mesh);
            } else {
                this.$camera.setTarget(objeto_estandar_o_babylon_mesh);
            }
            return this;
        }
        activarse() {
            Utilidades.tracear("Camara_estandar.activarse", arguments, this);
            this.homactografo.escena_actual.$scene.activeCamera = this.$camera;
            return this;
        }
    }
    ...
    class Luz_estandar extends Objeto_estandar {
        ...
        establecer_color() {
            throw new Error("La clase «Luz_estandar» no implementa el método «establecer_color» por el momento");
        }
        enfocarse_a(objeto_estandar_o_babylon_mesh) {
            Utilidades.tracear("Luz_estandar.enfocarse_a", arguments, this);
            if (objeto_estandar_o_babylon_mesh instanceof Objeto_estandar) {
                this.$light.setTarget(objeto_estandar_o_babylon_mesh.$mesh);
            } else {
                this.$light.setTarget(objeto_estandar_o_babylon_mesh);
            }
            return this;
        }
    }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    class Homactografo {
        ...
        cargar_eventos_del_dom() {
            Utilidades.tracear("Homactografo.cargar_eventos_del_dom", arguments, this);
        ...
        cargar_tipos() {
            ...
            this.tipos_de_sonido.Sonido_estandar = Sonido_estandar;
        ...
        selectores() {
            return {
                ...
                sonido: this.seleccionar_sonido.bind(this),
                sonidos: this.seleccionar_sonidos.bind(this),
                entrar: {
                    ...
                    sonido: this.crear_sonido.bind(this),
                ...
                salir: {
                    ...
                    sonido: this.eliminar_sonido.bind(this),
        ...
        crear_sonido(id, url, parametros = [], inicializador = undefined) {
            Utilidades.tracear("Homactografo.crear_sonido", arguments, this);
            return this.constructor.crear_instancia_en_homactografo(this, "sonido", "sonido", "Sonido_estandar", id, [url].concat(parametros), inicializador);
        }
        ...
        seleccionar_camaras(filtro = undefined) {
            ...
            return this.constructor.seleccionar_muchos_en_homactografo(this, "camara", filtro);
        }
        seleccionar_luces(filtro = undefined) {
            Utilidades.tracear("Homactografo.seleccionar_luces", arguments, this);
            return this.constructor.seleccionar_muchos_en_homactografo(this, "luz", filtro);
        }
        seleccionar_personas(filtro = undefined) {
            Utilidades.tracear("Homactografo.seleccionar_personas", arguments, this);
            return this.constructor.seleccionar_muchos_en_homactografo(this, "persona", filtro);
        }
        seleccionar_sonidos(filtro = undefined) {
            Utilidades.tracear("Homactografo.seleccionar_sonidos", arguments, this);
            return this.constructor.seleccionar_muchos_en_homactografo(this, "sonido", filtro);
        }
        seleccionar_objetos(filtro = undefined) {
            Utilidades.tracear("Homactografo.seleccionar_objetos", arguments, this);
            return this.constructor.seleccionar_muchos_en_homactografo(this, "objeto", filtro);
        }
        ...
        seleccionar_sonido(id = undefined) {
            Utilidades.tracear("Homactografo.seleccionar_sonido", arguments, this);
            return this.constructor.seleccionar_uno_en_homactografo(this, "sonido", id);
        }
        ...
        eliminar_sonido(id = undefined) {
            Utilidades.tracear("Homactografo.eliminar_sonido", arguments, this);
            return this.constructor.eliminar_instancia_en_homactografo(this, "sonido", id);
        }
